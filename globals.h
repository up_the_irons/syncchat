...
/* Global vars */
extern struct actions *action[500];
extern struct games_s *games[25];
extern struct channel_s *channel[99];

extern char done;
extern char snc_dir[256];
extern char old_dir[256];
extern char snc_root[256];
extern char bbs_soft_dir[128];
extern char toggles[10];
extern char bbs_software[64];
extern char onfile[81];
extern char entry_msg[128];
extern char exit_msg[128];
extern int num_of_actions;
extern int actions_on;
extern int dots_again;
extern int num_of_rooms;
extern int cur_room_num;
extern int reged;
extern int num_of_games;
extern int x_pos, y_pos;
extern int act_level;
extern char* generic_buf;

extern char *l1, *l2, *l3, *l4, *l5, *l6,  *l7, *l8, *l9,
